...
#define SWIGTYPE_p_GNCOptionDB swig_types[0]
#define SWIGTYPE_p_GNCOptionWin swig_types[1]
#define SWIGTYPE_p_GtkWidget swig_types[2]
#define SWIGTYPE_p_GtkWindow swig_types[3]
#define SWIGTYPE_p_QofBook swig_types[4]
#define SWIGTYPE_p_TaxTableWindow swig_types[5]
...
static SCM
_wrap_gnc_options_dialog_new (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-options-dialog-new"
  ...
  {
    arg2 = (GtkWindow *)SWIG_MustGetPtr(s_1, SWIGTYPE_p_GtkWindow, 2, 0);
  }
...
static SCM
_wrap_gnc_ui_tax_table_window_new (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-ui-tax-table-window-new"
  ...
  result = (TaxTableWindow *)gnc_ui_tax_table_window_new(arg1,arg2);
  {
    gswig_result = SWIG_NewPointerObj (result, SWIGTYPE_p_TaxTableWindow, 0);
  }
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-options-dialog-new", 2, 0, 0, (swig_guile_proc) _wrap_gnc_options_dialog_new);
  ...
  scm_c_define_gsubr("gnc-ui-tax-table-window-new", 2, 0, 0, (swig_guile_proc) _wrap_gnc_ui_tax_table_window_new);
}
