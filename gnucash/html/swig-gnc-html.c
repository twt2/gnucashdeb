...
#define SWIGTYPE_p_gint64 swig_types[3]
...
static char const *gswig_const_URL_TYPE_FILE = (char const *)("file");
static char const *gswig_const_URL_TYPE_JUMP = (char const *)("jump");
static char const *gswig_const_URL_TYPE_HTTP = (char const *)("http");
static char const *gswig_const_URL_TYPE_FTP = (char const *)("ftp");
static char const *gswig_const_URL_TYPE_SECURE = (char const *)("secure");
static char const *gswig_const_URL_TYPE_REGISTER = (char const *)("register");
static char const *gswig_const_URL_TYPE_ACCTTREE = (char const *)("accttree");
static char const *gswig_const_URL_TYPE_REPORT = (char const *)("report");
static char const *gswig_const_URL_TYPE_OPTIONS = (char const *)("options");
static char const *gswig_const_URL_TYPE_SCHEME = (char const *)("scheme");
static char const *gswig_const_URL_TYPE_HELP = (char const *)("help");
static char const *gswig_const_URL_TYPE_XMLDATA = (char const *)("xmldata");
static char const *gswig_const_URL_TYPE_PRICE = (char const *)("price");
static char const *gswig_const_URL_TYPE_OTHER = (char const *)("other");
static char const *gswig_const_URL_TYPE_BUDGET = (char const *)("budget");
static SCM
...
#define FUNC_NAME "URL-TYPE-FILE"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_FILE);
  }
...
#define FUNC_NAME "URL-TYPE-JUMP"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_JUMP);
  }
...
#define FUNC_NAME "URL-TYPE-HTTP"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_HTTP);
  }
...
#define FUNC_NAME "URL-TYPE-FTP"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_FTP);
  }
...
#define FUNC_NAME "URL-TYPE-SECURE"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_SECURE);
  }
...
#define FUNC_NAME "URL-TYPE-REGISTER"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_REGISTER);
  }
...
#define FUNC_NAME "URL-TYPE-ACCTTREE"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_ACCTTREE);
  }
...
#define FUNC_NAME "URL-TYPE-REPORT"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_REPORT);
  }
...
#define FUNC_NAME "URL-TYPE-OPTIONS"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_OPTIONS);
  }
...
#define FUNC_NAME "URL-TYPE-SCHEME"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_SCHEME);
  }
...
#define FUNC_NAME "URL-TYPE-HELP"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_HELP);
  }
...
#define FUNC_NAME "URL-TYPE-XMLDATA"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_XMLDATA);
  }
...
#define FUNC_NAME "URL-TYPE-PRICE"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_PRICE);
  }
...
#define FUNC_NAME "URL-TYPE-OTHER"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_OTHER);
  }
...
#define FUNC_NAME "URL-TYPE-BUDGET"
  ...
  {
    gswig_result = SWIG_str02scm(gswig_const_URL_TYPE_BUDGET);
  }
...
{
SWIG_init();
scm_c_export("URL-TYPE-FILE", "URL-TYPE-JUMP", "URL-TYPE-HTTP", "URL-TYPE-FTP", "URL-TYPE-SECURE", "URL-TYPE-REGISTER", "URL-TYPE-ACCTTREE", "URL-TYPE-REPORT", "URL-TYPE-OPTIONS", "URL-TYPE-SCHEME", "URL-TYPE-HELP", "URL-TYPE-XMLDATA", "URL-TYPE-PRICE", "URL-TYPE-OTHER", "URL-TYPE-BUDGET", "gnc-build-url", "gnc-html-engine-supports-css", NULL);
}
