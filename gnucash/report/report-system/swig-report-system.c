...
#define SWIGTYPE_p_gint64 swig_types[4]
...
static SCM
_wrap_gnc_report_find (SCM s_0)
{
#define FUNC_NAME "gnc-report-find"
  gint arg1 ;
  SCM gswig_result;
  ...
  result = (SCM)gnc_report_find(arg1);
  gswig_result=result;
...
static SCM
_wrap_gnc_report_add (SCM s_0)
{
#define FUNC_NAME "gnc-report-add"
  SCM arg1 ;
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  gint result;
  ...
  arg1=s_0;
  result = (gint)gnc_report_add(arg1);
  {
...
static SCM
_wrap_gnc_get_default_report_font_family ()
{
#define FUNC_NAME "gnc-get-default-report-font-family"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  gchar *result = 0 ;
  
  result = (gchar *)gnc_get_default_report_font_family();
  {
...
static SCM
_wrap_gnc_saved_reports_backup ()
{
#define FUNC_NAME "gnc-saved-reports-backup"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  
  gnc_saved_reports_backup();
  gswig_result = SCM_UNSPECIFIED;
...
static SCM
_wrap_gnc_saved_reports_write_to_file (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-saved-reports-write-to-file"
  gchar *arg1 = (gchar *) 0 ;
  gboolean arg2 ;
  int must_free1 = 0 ;
  SCM gswig_result;
  ...
  result = gnc_saved_reports_write_to_file((char const *)arg1,arg2);
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-report-find", 1, 0, 0, (swig_guile_proc) _wrap_gnc_report_find);
  scm_c_define_gsubr("gnc-report-add", 1, 0, 0, (swig_guile_proc) _wrap_gnc_report_add);
  scm_c_define_gsubr("gnc-get-default-report-font-family", 0, 0, 0, (swig_guile_proc) _wrap_gnc_get_default_report_font_family);
  scm_c_define_gsubr("gnc-saved-reports-backup", 0, 0, 0, (swig_guile_proc) _wrap_gnc_saved_reports_backup);
  scm_c_define_gsubr("gnc-saved-reports-write-to-file", 2, 0, 0, (swig_guile_proc) _wrap_gnc_saved_reports_write_to_file);
}
...
{
SWIG_init();
scm_c_export("gnc-report-find", "gnc-report-add", "gnc-get-default-report-font-family", "gnc-saved-reports-backup", "gnc-saved-reports-write-to-file", NULL);
}

SCM
scm_init_sw_report_system_module (void)
{
scm_c_define_module("sw_report_system",
