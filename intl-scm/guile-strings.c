...
/* src/app-utils/business-prefs.scm */
_("Choose the number of days after which transactions will be read-only and cannot be edited anymore. This threshold is marked by a red line in the account register windows. If zero, all transactions can be edited and none are read-only.")
/* src/app-utils/business-prefs.scm */
_("Check to have split action field used in registers for 'Num' field in place of transaction number; transaction number shown as 'T-Num' on second line of register. Has corresponding effect on business features, reporting and imports/exports.")
/* src/app-utils/business-prefs.scm */
...
/* src/report/business-reports/fancy-invoice.scm */
_("The minimum number of invoice entries to display.")
/* src/report/business-reports/fancy-invoice.scm */
_("Display")
/* src/report/business-reports/fancy-invoice.scm */
_("Extra Notes")
...
_("Job Details")
/* src/report/business-reports/invoice.scm */
_("Display the job name for this invoice?")
/* src/report/business-reports/invoice.scm */
_("Display")
/* src/report/business-reports/invoice.scm */
_("Extra Notes")
...
_("Display Columns")
/* src/report/business-reports/owner-report.scm */
_("Display the period credits column?")
/* src/report/business-reports/owner-report.scm */
_("Display Columns")
/* src/report/business-reports/owner-report.scm */
_("Display a period debits column?")
/* src/report/business-reports/owner-report.scm */
_("Display Columns")
/* src/report/business-reports/owner-report.scm */
_("Display the transaction amount?")
...
_("Show Job number")
/* src/report/business-reports/taxinvoice.scm */
_("Invoice number next to title")
/* src/report/business-reports/taxinvoice.scm */
_("table-border-collapse")
/* src/report/business-reports/taxinvoice.scm */
_("table-header-border-color")
/* src/report/business-reports/taxinvoice.scm */
_("table-cell-border-color")
/* src/report/business-reports/taxinvoice.scm */
_("Embedded CSS")
/* src/report/business-reports/taxinvoice.scm */
_("Report title")
...
_("Display the date?")
/* src/report/business-reports/taxinvoice.scm */
_("Display the Tax Rate?")
/* src/report/business-reports/taxinvoice.scm */
_("Display the Units?")
/* src/report/business-reports/taxinvoice.scm */
_("Display the contact?")
/* src/report/business-reports/taxinvoice.scm */
_("Display the address?")
/* src/report/business-reports/taxinvoice.scm */
_("Display the Invoice Number?")
/* src/report/business-reports/taxinvoice.scm */
_("Display the Company Name?")
/* src/report/business-reports/taxinvoice.scm */
_("Invoice Number next to title?")
/* src/report/business-reports/taxinvoice.scm */
_("Display Job name?")
/* src/report/business-reports/taxinvoice.scm */
_("Invoice Job number?")
/* src/report/business-reports/taxinvoice.scm */
...
/* src/report/locale-specific/us/taxtxf.scm */
_("Do not print T-Num:Memo data")
/* src/report/locale-specific/us/taxtxf.scm */
_("Do not print T-Num:Memo data for transactions.")
/* src/report/locale-specific/us/taxtxf.scm */
...
/* src/report/report-gnome/report-gnome.scm */
_("Saved Report Configurations")
/* src/report/report-gnome/report-gnome.scm */
_("Manage and run saved report configurations")
/* src/report/report-gnome/report-gnome.scm */
...
/* src/report/standard-reports/balance-sheet.scm */
_("Use standard US layout")
/* src/report/standard-reports/balance-sheet.scm */
_("Report section order is assets/liabilities/equity (rather than assets/equity/liabilities).")
/* src/report/standard-reports/balance-sheet.scm */
...
_("Num/Action")
/* src/report/standard-reports/register.scm */
_("Display the check number/action?")
/* src/report/standard-reports/register.scm */
_("Display")
/* src/report/standard-reports/register.scm */
_("Num")
