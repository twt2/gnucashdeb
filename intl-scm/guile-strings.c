...
/* src/business/business-utils/business-prefs.scm */
_("True if trading accounts should be used for transactions involving more than one commodity")
...
_(" For ")
/* src/report/locale-specific/us/taxtxf.scm */
_("Set as tax-related, but assigned tax code no longer valid for tax year")
/* src/report/locale-specific/us/taxtxf.scm */
_("Set as tax-related, tax code assigned for different tax entity type")
/* src/report/locale-specific/us/taxtxf.scm */
_("Set as not tax-related, but tax code assigned")
/* src/report/locale-specific/us/taxtxf.scm */
_("Set as not tax-related, tax code assigned for different tax entity type")
/* src/report/locale-specific/us/taxtxf.scm */
_("None")
/* src/report/locale-specific/us/taxtxf.scm */
_("Set as tax-related, no tax code assigned")
/* src/report/locale-specific/us/taxtxf.scm */
