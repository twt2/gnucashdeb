...
_("Tax Report & TXF Export")
/* src/report/locale-specific/us/taxtxf.scm */
_("Taxable Income / Deductible Expenses / Export to .TXF file")
/* src/report/locale-specific/us/taxtxf.scm */
...
/* src/report/standard-reports/category-barchart.scm */
_("Show barchart as stacked barchart? (Guppi>=0.35.4 required)")
/* src/report/standard-reports/category-barchart.scm */
...
_("Stylesheet")
/* src/report/report-system/report.scm */
_("A custom report with this name already exists. Either rename the report to store it with a different name, or edit your saved-reports file and delete the section with the following name: ")
/* src/report/report-system/report.scm */
...
_("Stylesheet")
/* src/report/report-system/report.scm */
_("Your report \"%s\" has been saved into the configuration file \"%s\".  The report will be available in the menu Reports -> Custom at the next startup of GnuCash.")
...
_("Current Year End")
/* src/app-utils/date-utilities.scm */
_("End of the current calendar year")
/* src/app-utils/date-utilities.scm */
...
/* src/app-utils/date-utilities.scm */
_("Start of Financial Period")
/* src/app-utils/date-utilities.scm */
_("Start of the accounting period, as set in the global preferences")
/* src/app-utils/date-utilities.scm */
_("End of Financial Period")
/* src/app-utils/date-utilities.scm */
_("End of the accounting period, as set in the global preferences")
/* src/app-utils/date-utilities.scm */
...
/* src/app-utils/date-utilities.scm */
_("The end of the latest quarterly accounting period")
/* src/app-utils/date-utilities.scm */
