...
static int gswig_const_GNC_HTML_GRAPH_GOG_EXTRAS_H = 1;
static char *gswig_const_GNC_CHART_PIE = "gnc-guppi-pie";
static char *gswig_const_GNC_CHART_BAR = "gnc-guppi-bar";
static char *gswig_const_GNC_CHART_LINE = "gnc-guppi-line";
static char *gswig_const_GNC_CHART_SCATTER = "gnc-guppi-scatter";
static SCM
...
static SCM
_wrap_gnc_html_engine_supports_css ()
{
#define FUNC_NAME "gnc-html-engine-supports-css"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  gboolean result;
  
  result = gnc_html_engine_supports_css();
...
static SCM
_wrap_GNC_HTML_GRAPH_GOG_EXTRAS_H(SCM s_0)
{
#define FUNC_NAME "GNC-HTML-GRAPH-GOG-EXTRAS-H"
  SCM gswig_result;
  
  {
    gswig_result = scm_long2num(gswig_const_GNC_HTML_GRAPH_GOG_EXTRAS_H);
  }
...
static SCM
_wrap_GNC_CHART_PIE(SCM s_0)
{
#define FUNC_NAME "GNC-CHART-PIE"
  SCM gswig_result;
  
  {
    gswig_result = scm_makfrom0str(gswig_const_GNC_CHART_PIE);
  }
...
static SCM
_wrap_GNC_CHART_BAR(SCM s_0)
{
#define FUNC_NAME "GNC-CHART-BAR"
  SCM gswig_result;
  
  {
    gswig_result = scm_makfrom0str(gswig_const_GNC_CHART_BAR);
  }
...
static SCM
_wrap_GNC_CHART_LINE(SCM s_0)
{
#define FUNC_NAME "GNC-CHART-LINE"
  SCM gswig_result;
  
  {
    gswig_result = scm_makfrom0str(gswig_const_GNC_CHART_LINE);
  }
...
static SCM
_wrap_GNC_CHART_SCATTER(SCM s_0)
{
#define FUNC_NAME "GNC-CHART-SCATTER"
  SCM gswig_result;
  
  {
    gswig_result = scm_makfrom0str(gswig_const_GNC_CHART_SCATTER);
  }
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-html-engine-supports-css", 0, 0, 0, (swig_guile_proc) _wrap_gnc_html_engine_supports_css);
  scm_c_define_gsubr("GNC-HTML-GRAPH-GOG-EXTRAS-H", 0, 0, 0, (swig_guile_proc) _wrap_GNC_HTML_GRAPH_GOG_EXTRAS_H);
  scm_c_define_gsubr("GNC-CHART-PIE", 0, 0, 0, (swig_guile_proc) _wrap_GNC_CHART_PIE);
  scm_c_define_gsubr("GNC-CHART-BAR", 0, 0, 0, (swig_guile_proc) _wrap_GNC_CHART_BAR);
  scm_c_define_gsubr("GNC-CHART-LINE", 0, 0, 0, (swig_guile_proc) _wrap_GNC_CHART_LINE);
  scm_c_define_gsubr("GNC-CHART-SCATTER", 0, 0, 0, (swig_guile_proc) _wrap_GNC_CHART_SCATTER);
  
  {
    ...
    snprintf(tmp, 100, "(set! %s (%s))", ("GNC-CHART-PIE"), ("GNC-CHART-PIE"));       scm_c_eval_string(tmp);;
    snprintf(tmp, 100, "(set! %s (%s))", ("GNC-CHART-BAR"), ("GNC-CHART-BAR"));       scm_c_eval_string(tmp);;
    snprintf(tmp, 100, "(set! %s (%s))", ("GNC-CHART-LINE"), ("GNC-CHART-LINE"));       scm_c_eval_string(tmp);;
    snprintf(tmp, 100, "(set! %s (%s))", ("GNC-CHART-SCATTER"), ("GNC-CHART-SCATTER"));       scm_c_eval_string(tmp);;
...
{
SWIG_init();
scm_c_export("URL-TYPE-FILE", "URL-TYPE-JUMP", "URL-TYPE-HTTP", "URL-TYPE-FTP", "URL-TYPE-SECURE", "URL-TYPE-REGISTER", "URL-TYPE-ACCTTREE", "URL-TYPE-REPORT", "URL-TYPE-OPTIONS", "URL-TYPE-SCHEME", "URL-TYPE-HELP", "URL-TYPE-XMLDATA", "URL-TYPE-PRICE", "URL-TYPE-OTHER", "URL-TYPE-BUDGET", "gnc-build-url", "gnc-html-engine-supports-css", "GNC-HTML-GRAPH-GOG-EXTRAS-H", "GNC-CHART-PIE", "GNC-CHART-BAR", "GNC-CHART-LINE", "GNC-CHART-SCATTER", NULL);
}

SCM
scm_init_sw_gnc_html_module (void)
{
scm_c_define_module("sw_gnc_html",
