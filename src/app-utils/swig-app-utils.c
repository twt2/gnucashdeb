...
#define FUNC_NAME "gnc-option-db-register-option"
  ...
  {
    arg1 = (GNCOptionDBHandle) scm_num2int(s_0, SCM_ARG1, FUNC_NAME);
  }
  arg2=s_1;
...
#define FUNC_NAME "number-to-words"
  ...
  {
    arg1 = (gdouble) scm_num2dbl(s_0, FUNC_NAME);
  }
...
#define FUNC_NAME "gnc-accounting-period-fiscal-start"
  ...
  result = (time_t)gnc_accounting_period_fiscal_start();
  {
...
#define FUNC_NAME "gnc-accounting-period-fiscal-end"
  ...
  result = (time_t)gnc_accounting_period_fiscal_end();
  {
    gswig_result = scm_long2num(result);
  }
...
static SCM
_wrap_gnc_parse_time_to_timet (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-parse-time-to-timet"
  gchar *arg1 = (gchar *) 0 ;
  gchar *arg2 = (gchar *) 0 ;
  int must_free1 = 0 ;
  int must_free2 = 0 ;
  ...
  result = (time_t)gnc_parse_time_to_timet((char const *)arg1,(char const *)arg2);
  {
    gswig_result = scm_long2num(result);
  }
  if (must_free1 && arg1) SWIG_free(arg1);
...
static swig_type_info _swigt__p_int = {"_p_int", "int *|gint *|time_t *|GNCOptionDBHandle *", 0, 0, (void*)0, 0};
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-parse-time-to-timet", 2, 0, 0, (swig_guile_proc) _wrap_gnc_parse_time_to_timet);
