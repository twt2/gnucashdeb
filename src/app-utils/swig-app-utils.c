...
#define SWIGTYPE_p_GNCOptionDB swig_types[2]
#define SWIGTYPE_p_GNCPrintAmountInfo swig_types[3]
#define SWIGTYPE_p_Process swig_types[4]
#define SWIGTYPE_p_QofBook swig_types[5]
#define SWIGTYPE_p_QofIdType swig_types[6]
