...
#define SWIGTYPE_p_GNCModule swig_types[0]
...
static SCM
_wrap_gnc_module_system_init ()
{
#define FUNC_NAME "gnc-module-system-init"
  SCM gswig_result;
...
static SCM
_wrap_gnc_module_system_refresh ()
{
#define FUNC_NAME "gnc-module-system-refresh"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
...
static SCM
_wrap_gnc_module_load (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-module-load"
  gchar *arg1 = (gchar *) 0 ;
  gint arg2 ;
  int must_free1 = 0 ;
  SCM gswig_result;
  ...
  {
    GNCModule * resultptr;
    resultptr = (GNCModule *) malloc(sizeof(GNCModule));
    memmove(resultptr, &result, sizeof(GNCModule));
    gswig_result = SWIG_NewPointerObj(resultptr, SWIGTYPE_p_GNCModule, 1);
  }
...
static SCM
_wrap_gnc_module_load_optional (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-module-load-optional"
  gchar *arg1 = (gchar *) 0 ;
  gint arg2 ;
  int must_free1 = 0 ;
  SCM gswig_result;
...
static SCM
_wrap_gnc_module_unload (SCM s_0)
{
#define FUNC_NAME "gnc-module-unload"
  GNCModule arg1 ;
  GNCModule *argp1 ;
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  ...
  {
    argp1 = (GNCModule *)SWIG_MustGetPtr(s_0, SWIGTYPE_p_GNCModule, 1, 0);
    arg1 = *argp1;
  }
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-module-system-init", 0, 0, 0, (swig_guile_proc) _wrap_gnc_module_system_init);
  scm_c_define_gsubr("gnc-module-system-refresh", 0, 0, 0, (swig_guile_proc) _wrap_gnc_module_system_refresh);
  scm_c_define_gsubr("gnc-module-load", 2, 0, 0, (swig_guile_proc) _wrap_gnc_module_load);
  scm_c_define_gsubr("gnc-module-load-optional", 2, 0, 0, (swig_guile_proc) _wrap_gnc_module_load_optional);
  scm_c_define_gsubr("gnc-module-unload", 1, 0, 0, (swig_guile_proc) _wrap_gnc_module_unload);
}
...
{
SWIG_init();
scm_c_export("gnc-module-system-init", "gnc-module-system-refresh", "gnc-module-load", "gnc-module-load-optional", "gnc-module-unload", NULL);
}

SCM
scm_init_sw_gnc_module_module (void)
{
scm_c_define_module("sw_gnc_module",
