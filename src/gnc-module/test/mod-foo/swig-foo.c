...
_wrap_foo_hello ()
{
#define FUNC_NAME "foo-hello"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  int result;
  
  result = (int)foo_hello();
  {
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("foo-hello", 0, 0, 0, (swig_guile_proc) _wrap_foo_hello);
}
...
{
SWIG_init();
scm_c_export("foo-hello", NULL);
}

SCM
scm_init_sw_foo_module (void)
{
scm_c_define_module("sw_foo",
