...
_wrap_bar_hello ()
{
#define FUNC_NAME "bar-hello"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  int result;
  
  result = (int)bar_hello();
  {
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("bar-hello", 0, 0, 0, (swig_guile_proc) _wrap_bar_hello);
}
...
{
SWIG_init();
scm_c_export("bar-hello", NULL);
}

SCM
scm_init_sw_bar_module (void)
{
scm_c_define_module("sw_bar",
