...
_wrap_baz_hello ()
{
#define FUNC_NAME "baz-hello"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  int result;
  
  result = (int)baz_hello();
  {
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("baz-hello", 0, 0, 0, (swig_guile_proc) _wrap_baz_hello);
}
...
{
SWIG_init();
scm_c_export("baz-hello", NULL);
}

SCM
scm_init_sw_baz_module (void)
{
scm_c_define_module("sw_baz",
