...
def gnc_split_get_type(*args):
  """gnc_split_get_type() -> GType"""
  return _gnucash_core_c.gnc_split_get_type(*args)
...
def gnc_account_get_type(*args):
  """gnc_account_get_type() -> GType"""
  return _gnucash_core_c.gnc_account_get_type(*args)
...
def gnc_get_account_separator_string(*args):
  """gnc_get_account_separator_string() -> gchar"""
  return _gnucash_core_c.gnc_get_account_separator_string(*args)

def gnc_get_account_separator(*args):
  """gnc_get_account_separator() -> gunichar"""
  return _gnucash_core_c.gnc_get_account_separator(*args)
...
def xaccAccountSetType(*args):
  """xaccAccountSetType(Account account, GNCAccountType ?)"""
...
def xaccAccountGetType(*args):
  """xaccAccountGetType(Account account) -> int"""
...
def xaccAccountStringToEnum(*args):
  """xaccAccountStringToEnum(char str) -> int"""
...
def xaccAccountGetTypeFromStr(*args):
  """xaccAccountGetTypeFromStr(gchar str) -> int"""
...
def xaccAccountTypesValid(*args):
  """xaccAccountTypesValid() -> guint32"""
  return _gnucash_core_c.xaccAccountTypesValid(*args)
...
def xaccAccountGetDescendantPlaceholder(*args):
  """xaccAccountGetDescendantPlaceholder(Account account) -> int"""
...
def gnc_transaction_get_type(*args):
  """gnc_transaction_get_type() -> GType"""
  return _gnucash_core_c.gnc_transaction_get_type(*args)
...
def gnc_lot_get_type(*args):
  """gnc_lot_get_type() -> GType"""
  return _gnucash_core_c.gnc_lot_get_type(*args)

def gnc_lot_new(*args):
  """gnc_lot_new(QofBook ?) -> GNCLot"""
  return _gnucash_core_c.gnc_lot_new(*args)

def gnc_lot_destroy(*args):
  """gnc_lot_destroy(GNCLot ?)"""
...
def gnc_lot_get_book(*args):
  """gnc_lot_get_book(GNCLot ?) -> QofBook"""
...
def qof_backend_get_error(*args):
  """qof_backend_get_error(QofBackend be) -> int"""
...
def qof_finalize_backend_libraries(*args):
  """qof_finalize_backend_libraries()"""
  return _gnucash_core_c.qof_finalize_backend_libraries(*args)
...
def qof_session_get_error(*args):
  """qof_session_get_error(QofSession session) -> int"""
...
def qof_session_pop_error(*args):
  """qof_session_pop_error(QofSession session) -> int"""
...
def qof_backend_get_registered_access_method_list(*args):
  """qof_backend_get_registered_access_method_list() -> GList"""
  return _gnucash_core_c.qof_backend_get_registered_access_method_list(*args)
...
def qof_get_alt_dirty_mode(*args):
  """qof_get_alt_dirty_mode() -> gboolean"""
  return _gnucash_core_c.qof_get_alt_dirty_mode(*args)
...
def qof_collection_get_type(*args):
  """qof_collection_get_type(QofCollection ?) -> QofIdType"""
  return _gnucash_core_c.qof_collection_get_type(*args)

def qof_collection_lookup_entity(*args):
  """qof_collection_lookup_entity(QofCollection ?,  ?) -> QofInstance"""
  return _gnucash_core_c.qof_collection_lookup_entity(*args)

def qof_collection_foreach(*args):
  """qof_collection_foreach(QofCollection ?, QofInstanceForeachCB ?, gpointer user_data)"""
...
class GncGUID(_object):
    ...
    def __init__(self, *args): 
        ...
        this = _gnucash_core_c.new_GncGUID(*args)
        try: self.this.append(this)
        except: self.this = this
...
def gnc_guid_get_type(*args):
  """gnc_guid_get_type() -> GType"""
  return _gnucash_core_c.gnc_guid_get_type(*args)
...
def guid_init(*args):
  """guid_init()"""
  return _gnucash_core_c.guid_init(*args)
...
def guid_shutdown(*args):
  """guid_shutdown()"""
  return _gnucash_core_c.guid_shutdown(*args)

def guid_new(*args):
  """guid_new( guid)"""
  return _gnucash_core_c.guid_new(*args)

def guid_new_return(*args):
  """guid_new_return()"""
  return _gnucash_core_c.guid_new_return(*args)

def guid_null(*args):
  """guid_null()"""
  return _gnucash_core_c.guid_null(*args)

def guid_malloc(*args):
  """guid_malloc()"""
  return _gnucash_core_c.guid_malloc(*args)
...
def guid_hash_table_new(*args):
  """guid_hash_table_new() -> GHashTable"""
  return _gnucash_core_c.guid_hash_table_new(*args)
...
def gnc_numeric_zero(*args):
  """gnc_numeric_zero() -> gnc_numeric"""
  return _gnucash_core_c.gnc_numeric_zero(*args)
...
def gnc_numeric_check(*args):
  """gnc_numeric_check(gnc_numeric a) -> int"""
...
def gnc_numeric_get_type(*args):
  """gnc_numeric_get_type() -> GType"""
  return _gnucash_core_c.gnc_numeric_get_type(*args)

def gnc_commodity_get_type(*args):
  """gnc_commodity_get_type() -> GType"""
  return _gnucash_core_c.gnc_commodity_get_type(*args)

def gnc_commodity_namespace_get_type(*args):
  """gnc_commodity_namespace_get_type() -> GType"""
  return _gnucash_core_c.gnc_commodity_namespace_get_type(*args)
...
def gnc_quote_source_fq_installed(*args):
  """gnc_quote_source_fq_installed() -> gboolean"""
  return _gnucash_core_c.gnc_quote_source_fq_installed(*args)
...
def gnc_quote_source_get_type(*args):
  """gnc_quote_source_get_type(gnc_quote_source source) -> int"""
...
def gnc_commodity_table_new(*args):
  """gnc_commodity_table_new() -> gnc_commodity_table"""
  return _gnucash_core_c.gnc_commodity_table_new(*args)
...
def gnc_commodity_table_register(*args):
  """gnc_commodity_table_register() -> gboolean"""
  return _gnucash_core_c.gnc_commodity_table_register(*args)
...
def gncOwnerRegister(*args):
  """gncOwnerRegister() -> gboolean"""
  return _gnucash_core_c.gncOwnerRegister(*args)
...
def gncOwnerGetType(*args):
  """gncOwnerGetType(GncOwner owner) -> int"""
...
def gncOwnerCreate(*args):
  """gncOwnerCreate() -> GncOwner"""
  return _gnucash_core_c.gncOwnerCreate(*args)
...
def gnc_customer_get_type(*args):
  """gnc_customer_get_type() -> GType"""
  return _gnucash_core_c.gnc_customer_get_type(*args)
...
def gncCustomerGetTaxIncluded(*args):
  """gncCustomerGetTaxIncluded(GncCustomer customer) -> int"""
...
def gnc_employee_get_type(*args):
  """gnc_employee_get_type() -> GType"""
  return _gnucash_core_c.gnc_employee_get_type(*args)
...
def gnc_vendor_get_type(*args):
  """gnc_vendor_get_type() -> GType"""
  return _gnucash_core_c.gnc_vendor_get_type(*args)
...
def gncVendorGetTaxIncluded(*args):
  """gncVendorGetTaxIncluded(GncVendor vendor) -> int"""
...
def gnc_address_get_type(*args):
  """gnc_address_get_type() -> GType"""
  return _gnucash_core_c.gnc_address_get_type(*args)
...
def gnc_billterm_get_type(*args):
  """gnc_billterm_get_type() -> GType"""
  return _gnucash_core_c.gnc_billterm_get_type(*args)
...
def gncBillTermGetType(*args):
  """gncBillTermGetType(GncBillTerm term) -> int"""
...
def gnc_invoice_get_type(*args):
  """gnc_invoice_get_type() -> GType"""
  return _gnucash_core_c.gnc_invoice_get_type(*args)
...
def gncInvoiceGetOwnerType(*args):
  """gncInvoiceGetOwnerType(GncInvoice invoice) -> int"""
...
def gnc_job_get_type(*args):
  """gnc_job_get_type() -> GType"""
  return _gnucash_core_c.gnc_job_get_type(*args)
...
def gnc_entry_get_type(*args):
  """gnc_entry_get_type() -> GType"""
  return _gnucash_core_c.gnc_entry_get_type(*args)
...
def gncEntryGetInvDiscountType(*args):
  """gncEntryGetInvDiscountType(GncEntry entry) -> int"""
  return _gnucash_core_c.gncEntryGetInvDiscountType(*args)

def gncEntryGetInvDiscountHow(*args):
  """gncEntryGetInvDiscountHow(GncEntry entry) -> int"""
...
def gncEntryGetBillPayment(*args):
  """gncEntryGetBillPayment(GncEntry entry) -> int"""
...
def gnc_taxtable_get_type(*args):
  """gnc_taxtable_get_type() -> GType"""
  return _gnucash_core_c.gnc_taxtable_get_type(*args)
...
def gncTaxTableEntryCreate(*args):
  """gncTaxTableEntryCreate() -> GncTaxTableEntry"""
  return _gnucash_core_c.gncTaxTableEntryCreate(*args)
...
def gncTaxTableEntryGetType(*args):
  """gncTaxTableEntryGetType(GncTaxTableEntry entry) -> int"""
...
class _gncAccountValue(_object):
    ...
    def __init__(self, *args): 
        ...
        this = _gnucash_core_c.new__gncAccountValue(*args)
        try: self.this.append(this)
        except: self.this = this
...
def gnc_price_get_type(*args):
  """gnc_price_get_type() -> GType"""
  return _gnucash_core_c.gnc_price_get_type(*args)

def gnc_pricedb_get_type(*args):
  """gnc_pricedb_get_type() -> GType"""
  return _gnucash_core_c.gnc_pricedb_get_type(*args)
