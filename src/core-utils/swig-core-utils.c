...
static SCM
_wrap_g_find_program_in_path (SCM s_0)
{
#define FUNC_NAME "g-find-program-in-path"
  gchar *arg1 = (gchar *) 0 ;
  int must_free1 = 0 ;
  SCM gswig_result;
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("g-find-program-in-path", 1, 0, 0, (swig_guile_proc) _wrap_g_find_program_in_path);
...
{
SWIG_init();
scm_c_export("g-find-program-in-path", "gnc-is-debugging", "gnc-scm-log-warn", "gnc-scm-log-error", "gnc-scm-log-msg", "gnc-scm-log-debug", "gnc-utf8-strip-invalid-strdup", "gnc-locale-from-utf8", "gnc-locale-to-utf8", "gnc-utf8?", NULL);
}
