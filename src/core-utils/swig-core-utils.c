...
static SCM
_wrap_gnc_is_debugging ()
{
#define FUNC_NAME "gnc-is-debugging"
  SCM gswig_result;
  SWIGUNUSED int gswig_list_p = 0;
  gboolean result;
  
  result = gnc_is_debugging();
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-is-debugging", 0, 0, 0, (swig_guile_proc) _wrap_gnc_is_debugging);
