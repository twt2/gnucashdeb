...
static int gswig_const_G_LOG_FLAG_FATAL = G_LOG_FLAG_FATAL;
static int gswig_const_G_LOG_LEVEL_ERROR = G_LOG_LEVEL_ERROR;
static int gswig_const_G_LOG_LEVEL_CRITICAL = G_LOG_LEVEL_CRITICAL;
static int gswig_const_G_LOG_LEVEL_WARNING = G_LOG_LEVEL_WARNING;
static int gswig_const_G_LOG_LEVEL_MESSAGE = G_LOG_LEVEL_MESSAGE;
static int gswig_const_G_LOG_LEVEL_INFO = G_LOG_LEVEL_INFO;
static int gswig_const_G_LOG_LEVEL_DEBUG = G_LOG_LEVEL_DEBUG;
static int gswig_const_G_LOG_LEVEL_MASK = G_LOG_LEVEL_MASK;
