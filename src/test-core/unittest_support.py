...
class TestErrorStruct(_object):
    ...
    if _newclass:log_level = _swig_property(_unittest_support.TestErrorStruct_log_level_get, _unittest_support.TestErrorStruct_log_level_set)
    ...
    if _newclass:log_domain = _swig_property(_unittest_support.TestErrorStruct_log_domain_get, _unittest_support.TestErrorStruct_log_domain_set)
    ...
    if _newclass:msg = _swig_property(_unittest_support.TestErrorStruct_msg_get, _unittest_support.TestErrorStruct_msg_set)
    def __init__(self): 
...
def test_add_error(*args):
  return _unittest_support.test_add_error(*args)
...
def test_set_checked_handler(*args):
  return _unittest_support.test_set_checked_handler(*args)
test_set_checked_handler = _unittest_support.test_set_checked_handler

def test_set_list_handler(*args):
  return _unittest_support.test_set_list_handler(*args)
test_set_list_handler = _unittest_support.test_set_list_handler

def test_set_null_handler(*args):
  return _unittest_support.test_set_null_handler(*args)
test_set_null_handler = _unittest_support.test_set_null_handler

def g_log_remove_handler(*args):
  return _unittest_support.g_log_remove_handler(*args)
