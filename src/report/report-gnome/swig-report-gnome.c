...
#define SWIGTYPE_p_GncMainWindow swig_types[0]
...
static SCM
_wrap_gnc_report_raise_editor (SCM s_0)
{
...
static SCM
_wrap_gnc_main_window_open_report (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-main-window-open-report"
  int arg1 ;
  ...
  {
    arg2 = (GncMainWindow *)SWIG_MustGetPtr(s_1, SWIGTYPE_p_GncMainWindow, 2, 0);
  }
  gnc_main_window_open_report(arg1,arg2);
  gswig_result = SCM_UNSPECIFIED;
...
static SCM
_wrap_gnc_report_window_default_params_editor (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-report-window-default-params-editor"
  SCM arg1 ;
  SCM arg2 ;
  GtkWidget *result = 0 ;
  SCM gswig_result;
  ...
  arg1=s_0;
  arg2=s_1;
  result = (GtkWidget *)gnc_report_window_default_params_editor(arg1,arg2);
  {
...
static SCM
_wrap_gnc_column_view_edit_options (SCM s_0, SCM s_1)
{
#define FUNC_NAME "gnc-column-view-edit-options"
  SCM arg1 ;
  SCM arg2 ;
  GtkWidget *result = 0 ;
  SCM gswig_result;
  ...
  arg1=s_0;
  arg2=s_1;
  result = (GtkWidget *)gnc_column_view_edit_options(arg1,arg2);
  {
    gswig_result = SWIG_NewPointerObj (result, SWIGTYPE_p_GtkWidget, 0);
  }
...
static swig_type_info _swigt__p_GncMainWindow = {"_p_GncMainWindow", "GncMainWindow *", 0, 0, (void*)0, 0};
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("gnc-report-raise-editor", 1, 0, 0, (swig_guile_proc) _wrap_gnc_report_raise_editor);
...
SCM
scm_init_sw_report_gnome_module (void)
{
scm_c_define_module("sw_report_gnome",
